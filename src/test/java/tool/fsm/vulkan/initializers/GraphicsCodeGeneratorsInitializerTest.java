 ...
 */
public class GraphicsCodeGeneratorsInitializerTest {
    private GraphicsCodeGeneratorsInitializer initializer;

    @Before
    public void setup() {
        initializer = new GraphicsCodeGeneratorsInitializer(new VulkanGlobalState());
    }
